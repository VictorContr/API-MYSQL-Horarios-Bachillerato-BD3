import GradoAsignaturaModel_vc_bb from "../models/gradoAsignatura.model.js";
...
class GradoAsignaturaController_vc_bb {
  ...
  async crear_vc_bb(req_vc_bb, res_vc_bb) {
    try {
      ...
      try {
        ...
        if (String(error_vc_bb?.code || "").includes("ER_DUP_ENTRY")) {
  ...
  async actualizar_vc_bb(req_vc_bb, res_vc_bb) {
    try {
      ...
      try {
        const cambios_vc_bb = await this.model_vc_bb.actualizar_vc_bb(id, { ID_grado_gradoAsig_bb_vc, ID_asignatura_gradoAsig_bb_vc });
