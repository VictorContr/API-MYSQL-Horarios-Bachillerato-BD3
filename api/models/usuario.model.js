...
export class UsuarioModel_vc_bb {
  ...
  async obtenerTodos_vc_bb() {
    ...
    `;
    return await db_vc_bb.query_vc_bb(sql_vc_bb);
  }
  ...
  async obtenerPorId_vc_bb(id_vc_bb) {
    const sql_vc_bb = `
      ...
      LIMIT 1
    `;
    return await db_vc_bb.getOne_vc_bb(sql_vc_bb, [id_vc_bb]);
  }
  ...
  async actualizar_vc_bb(id_vc_bb, datos_vc_bb) {
    ...
    const result_vc_bb = await db_vc_bb.execute_vc_bb(sql_vc_bb, valores_vc_bb);
  ...
  async eliminar_vc_bb(id_vc_bb) {
    ...
    const result_vc_bb = await db_vc_bb.execute_vc_bb(sql_vc_bb, [id_vc_bb]);
    return result_vc_bb.affectedRows;
  }
  ...
  async obtenerRol_vc_bb(id_vc_bb) {
    const sql_vc_bb = `
      ...
      LIMIT 1
    `;
    const row_vc_bb = await db_vc_bb.getOne_vc_bb(sql_vc_bb, [id_vc_bb]);
