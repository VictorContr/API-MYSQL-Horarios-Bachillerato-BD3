...
export class UsuarioRolModel_vc_bb {
  ...
  async obtenerPorUsuario_vc_bb(idUsuario_vc_bb) {
    const sql_vc_bb = `
      ...
      LIMIT 1
    `;
    return await db_vc_bb.getOne_vc_bb(sql_vc_bb, [idUsuario_vc_bb]);
  }
  ...
  async obtenerPorUsuarioYRol_vc_bb(idUsuario_vc_bb, idRol_vc_bb) {
    const sql_vc_bb = `
      ...
      LIMIT 1
    `;
    return await db_vc_bb.getOne_vc_bb(sql_vc_bb, [idUsuario_vc_bb, idRol_vc_bb]);
  }
  ...
  async crear_vc_bb(idUsuario_vc_bb, idRol_vc_bb) {
    const sql_vc_bb = `
      ...
      VALUES (?, ?)
    `;
    const result_vc_bb = await db_vc_bb.execute_vc_bb(sql_vc_bb, [idUsuario_vc_bb, idRol_vc_bb]);
    if (result_vc_bb.insertId && result_vc_bb.insertId > 0) return result_vc_bb.insertId;
  ...
  async eliminar_vc_bb(idUsuarioRol_vc_bb) {
    ...
    const result_vc_bb = await db_vc_bb.execute_vc_bb(sql_vc_bb, [idUsuarioRol_vc_bb]);
    return result_vc_bb.affectedRows;
  }
}
