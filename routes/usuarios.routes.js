...
import { requireAdmin_vc_bb, preventSelfDelete_vc_bb } from "../middleware/auth.middleware.js";
...
router_vc_bb.delete('/:id', requireAdmin_vc_bb, preventSelfDelete_vc_bb, deleteUsuario_vc_bb);
