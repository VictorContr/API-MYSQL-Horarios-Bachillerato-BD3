...
import { getAllSecciones_vc_bb, getSeccionById_vc_bb, createSeccion_vc_bb, updateSeccion_vc_bb, deleteSeccion_vc_bb } from "../api/controllers/secciones.controller.js";
...
router_vc_bb.get("/:id", getSeccionById_vc_bb);
